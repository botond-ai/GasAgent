...
class IDocumentsRAGClient(IToolClient):
    """Interface for documents RAG (Retrieval-Augmented Generation) service using FAISS vector database."""
...
class IGoogleDriveClient(IToolClient):
    """Interface for Google Drive service for photo uploads."""
...
class IPCloudClient(IToolClient):
    """Interface for pCloud service for photo uploads."""
