...
class FileUserRepository(IUserRepository):
    ...
    async def save_profile(self, profile: UserProfile) -> None:
        """Save user profile to storage with atomic write."""
...
class FileConversationRepository(IConversationRepository):
    ...
    async def save_history(self, history: ConversationHistory) -> None:
        """Save conversation history to storage with atomic write."""
        ...
        try:
            ...
            if temp_path.exists():
                try:
                    ...
                    pass
            logger.error(f"Failed to save history for {history.session_id}: {e}")
            raise
