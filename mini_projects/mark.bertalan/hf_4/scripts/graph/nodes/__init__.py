...
from scripts.graph.nodes.planner import plan_query_node, set_llm as set_planner_llm
...
from scripts.graph.nodes.teams_notify import send_teams_notification_node, set_teams_config


def set_dependencies(embedder, vector_store, llm, jira_config=None, teams_config=None):
    """
